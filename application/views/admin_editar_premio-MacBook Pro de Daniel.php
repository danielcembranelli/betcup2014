...
<html>
    <head>
        ...
        <title>Editar Prêmio - BetCup2014</title>
        ...
        <div class="container" id="main-container">
            ...
            <div id="main-content">
                <div class="page-title">
                    <div>
                        <h1><i class="icon-trophy"></i> Editar Prêmio</h1>
                    </div>
                </div>
                ...
                <div id="breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li class="active">Editar Prêmio</li>
                    </ul>
                </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="box">
                            ...
                            <div class="box-content">
                                <?php echo form_open_multipart('admin/edita_premio/' . $premio->id, 'class="form-horizontal valida"'); ?>
                                    <div class="form-group">
                                        <label class="col-sm-3 col-lg-2 control-label">Ativo</label>
                                        <div class="col-sm-9 col-lg-10 controls">
                                            <label class="checkbox">
                                                <input type="checkbox" name="ativo" value="1" <?php if ($premio->ativo) echo "checked=\"checked\""; ?> />
                                            </label>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9 col-lg-10 controls">
                                            <select name="campeonato" class="form-control valida" tabindex="1">
                                                <option value="">Selecione</option>
                                                <?php foreach ($campeonatos->result() as $row) { ?>
                                                    <option value="<?php echo $row->id; ?>" <?php if ($row->id == $premio->campeonato) echo "selected=\"selected\""; ?>><?php echo $row->campeonato; ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 col-lg-2 control-label">Prêmio</label>
                                        <div class="col-sm-9 col-lg-10 controls">
                                            <input type="text" name="premio" placeholder="Prêmio" value="<?php echo $premio->premio; ?>" class="form-control valida" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 col-lg-2 control-label">Foto</label>
                                        <div class="col-sm-9 col-lg-10 controls">
                                            <input type="file" name="foto"> <img src="<?php echo base_url('imagens/premios/' . $premio->foto . ''); ?>" alt="<?php echo $premio->premio; ?>">
                                            <div id="progress">
                                                <div id="bar"></div>
