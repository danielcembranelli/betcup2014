        ...
        <section id="geral">
            ...
            <article class="wrap">
                ...
                <div class="content">
                    ...
                    <?php echo form_open('editar/tabela_edita/' . $this->uri->segment("3"), 'id="form-oitavas" class="valida"'); ?>
                    <h3 class="form_resposta"></h3>
                        ...
                        <p class="txt_r">
                            ...
                            <input type="image" src="<?php echo base_url('assets/pt/images/buttons/btn-salvar.png'); ?>" class="btn-apostar">
                        </p>
