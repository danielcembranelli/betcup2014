        ...
        <section id="geral">
            ...
            <article class="wrap">
                ...
                <div class="content">
                    ...
                    <h3><?php echo $this->lang->line('aviso_informar_email_para_enviar_link'); ?></h3>
                    <?php echo form_open('esqueceu_senha/enviar', 'id="form-login" class="valida"'); ?>
                    ...
                    <p><a class="mini-link" href="<?php echo base_url('login'); ?>"><?php echo $this->lang->line('Fazer_Login'); ?></a> <input class="btn-apostar" type="image" src="<?php echo base_url('assets/' . $this->session->userdata('idioma') . '/images/buttons/btn-entrar.png'); ?>"></p>
                    </form>
