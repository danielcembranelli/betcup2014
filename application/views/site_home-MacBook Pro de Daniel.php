...
<html>
    <head>
		...
		<script src="<?php echo base_url('assets/todos/js/jquery.counterup.js'); ?>"></script>
    ...
    <body class="home">
        ...
        <section id="geral">
            ...
            <article class="wrap">
                ...
                <div class="mobile">
                    <img src="<?php echo base_url('assets/' . $this->session->userdata('idioma') . '/images/pics/slideshow/01-mobile.jpg'); ?>" alt="slide-mobile">
            ...
            <div>
        <span class="counter" style="display: inline-block; width: 32%; color:#FFF">12345</span>
    </div>
