...
<html>
    <head>
        ...
        <title>Cadastrar Campeonato - BetCup2014</title>
        ...
        <div class="container" id="main-container">
            ...
            <div id="main-content">
                <div class="page-title">
                    <div>
                        <h1><i class="icon-sitemap"></i> Campeonato</h1>
                    </div>
                </div>
                ...
                <div id="breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li class="active">Cadastrar Campeonato</li>
                    </ul>
                </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="box">
                            ...
                            <div class="box-content">
                                <?php echo form_open('admin/insere_campeonato', 'class="form-horizontal valida"'); ?>
                                    <div class="form-group">
                                        <label class="col-sm-3 col-lg-2 control-label">Campeonato</label>
                                        <div class="col-sm-9 col-lg-10 controls">
                                            <input type="text" name="campeonato" placeholder="Campeonato" class="form-control valida" />
                                        </div>
                                    </div>
                                    <div class="form-group">
