...
<html>
    <head>
        ...
        <title><?php echo $campeonato->campeonato; ?> - Editar Time - BetCup2014</title>
        ...
        <link rel="stylesheet" href="<?php echo base_url('flaty/css/progress.css'); ?>">
    ...
    <body>
        ...
        <div class="container" id="main-container">
            ...
            <div id="main-content">
                <div class="page-title">
                    <div>
                        <h1><i class="icon-group"></i> <?php echo $campeonato->campeonato; ?> - Editar Time</h1>
                    </div>
                </div>
                ...
                <div id="breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li class="active">Editar Time</li>
                    </ul>
                </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="box">
                            ...
                            <div class="box-content">
                                <?php echo form_open_multipart('admin/edita_time/' . $query->id . '/' . $campeonato->id, 'class="form-horizontal valida"'); ?>
                                    <div class="form-group">
                                        <label class="col-sm-3 col-lg-2 control-label">Ranking</label>
                                        <div class="col-sm-9 col-lg-10 controls">
                                            <input type="text" name="ranking" placeholder="Ranking" value="<?php echo $query->ranking; ?>" class="form-control valida" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 col-lg-2 control-label">Time</label>
                                        <div class="col-sm-9 col-lg-10 controls">
                                            <input type="text" name="time" placeholder="Time" value="<?php echo $query->time; ?>" class="form-control valida" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 col-lg-2 control-label">Foto</label>
                                        <div class="col-sm-9 col-lg-10 controls">
                                            <input type="file" name="foto"> <img src="<?php echo base_url('imagens/times/' . $query->foto . ''); ?>" alt="<?php echo $query->time; ?>">
                                            <div id="progress">
                                                <div id="bar"></div>
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-3 col-lg-2 control-label">Descri&ccedil;&atilde;o</label>
                                        <div class="col-sm-9 col-lg-10 controls">
                                            <textarea name="descricao" class="form-control valida" rows="3"><?php echo $query->descricao; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
        ...
        <script src="<?php echo base_url('flaty/js/jquery.form.js'); ?>"></script>
        <script src="<?php echo base_url('flaty/js/validaformfile.js'); ?>"></script>
