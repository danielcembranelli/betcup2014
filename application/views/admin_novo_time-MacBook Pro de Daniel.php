...
<html>
    <head>
        ...
        <title><?php echo $campeonato->campeonato; ?> - Cadastrar Time - BetCup2014</title>
        ...
        <div class="container" id="main-container">
            ...
            <div id="main-content">
                ...
                <div class="page-title">
                    <div>
                        <h1><i class="icon-group"></i> <?php echo $campeonato->campeonato; ?> - Cadastrar Time</h1>
                    </div>
                </div>
                ...
                <div id="breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li class="active">Cadastrar Time</li>
                    </ul>
                </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="box">
                            ...
                            <div class="box-content">
                                    <?php echo form_open_multipart('admin/insere_time/' . $campeonato->id, 'class="form-horizontal valida"'); ?>
                                    <div class="form-group">
                                        <label class="col-sm-3 col-lg-2 control-label">Ranking</label>
                                        <div class="col-sm-9 col-lg-10 controls">
                                            <input type="text" name="ranking" placeholder="Ranking" class="form-control valida" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 col-lg-2 control-label">Time</label>
                                        <div class="col-sm-9 col-lg-10 controls">
                                            <input type="text" name="time" placeholder="Time" class="form-control valida" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 col-lg-2 control-label">Foto</label>
                                        <div class="col-sm-9 col-lg-10 controls">
                                            <input type="file" name="foto" class="valida">
                                            <div id="progress">
                                                <div id="bar"></div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9 col-lg-10 controls">
                                            <textarea name="descricao" class="form-control valida" rows="3"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2">
                                            <input type="hidden" name="json" value="true">
                                            <button type="submit" name="submit" class="btn btn-primary"><i class="icon-ok"></i> Cadastrar</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
