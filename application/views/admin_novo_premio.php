...
<html>
    <head>
        ...
        <title>Cadastrar Prêmio - BetCup2014</title>
        ...
        <div class="container" id="main-container">
            ...
            <div id="main-content">
                <div class="page-title">
                    <div>
                        <h1><i class="icon-trophy"></i> Cadastrar Pr&ecirc;mio</h1>
                    </div>
                </div>
                ...
                <div id="breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li class="active">Cadastrar Pr&ecirc;mio</li>
                    </ul>
                </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="box">
                            ...
                            <div class="box-content">
                                <?php echo form_open_multipart('admin/insere_premio', 'class="form-horizontal valida"'); ?>
                                    ...
                                    <div class="col-sm-9 col-lg-10 controls">
                                        <select name="campeonato" class="form-control valida" tabindex="1">
                                            ...
                                            <?php foreach ($campeonatos->result() as $row) { ?>
                                                <option value="<?php echo $row->id; ?>"><?php echo $row->campeonato; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9 col-lg-10 controls">
                                        <input type="text" name="premio" placeholder="Prêmio" class="form-control valida" />
                                    </div>
                                </div>
                                <div class="form-group">
