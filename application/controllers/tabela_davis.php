...
class Tabela_davis extends CI_Controller {

    function tabela_davis() {
        parent::__construct();
    ...
    public function premio() {
        ...
        $data['jogo']['49'] = $this->db->query("SELECT * FROM jogos WHERE fase = 'oitavas' AND id = '113'", $this->uri->segment("3"))->row(0);
        $data['jogo']['50'] = $this->db->query("SELECT * FROM jogos WHERE fase = 'oitavas' AND id = '114'", $this->uri->segment("3"))->row(0);
        $data['jogo']['51'] = $this->db->query("SELECT * FROM jogos WHERE fase = 'oitavas' AND id = '115'", $this->uri->segment("3"))->row(0);
        $data['jogo']['52'] = $this->db->query("SELECT * FROM jogos WHERE fase = 'oitavas' AND id = '116'", $this->uri->segment("3"))->row(0);
        $data['jogo']['53'] = $this->db->query("SELECT * FROM jogos WHERE fase = 'oitavas' AND id = '117'", $this->uri->segment("3"))->row(0);
        $data['jogo']['54'] = $this->db->query("SELECT * FROM jogos WHERE fase = 'oitavas' AND id = '118'", $this->uri->segment("3"))->row(0);
        $data['jogo']['55'] = $this->db->query("SELECT * FROM jogos WHERE fase = 'oitavas' AND id = '119'", $this->uri->segment("3"))->row(0);
        $data['jogo']['56'] = $this->db->query("SELECT * FROM jogos WHERE fase = 'oitavas' AND id = '120'", $this->uri->segment("3"))->row(0);
        
        $this->load->view('site_tabela_davis', $data);
    }
    ...
    public function salvar() {
        ...
        $data['aposta'] = $this->db->query("SELECT * FROM apostas_tmp WHERE id = ?", $this->uri->segment("3"))->row(0);
        $data['jogo']['49'] = $this->db->query("SELECT * FROM jogos WHERE fase = 'oitavas' AND id =  = '49'", $this->uri->segment("3"))->row(0);
        $data['jogo']['50'] = $this->db->query("SELECT * FROM jogos WHERE fase = 'oitavas' AND id =  = '50'", $this->uri->segment("3"))->row(0);
        $data['jogo']['51'] = $this->db->query("SELECT * FROM jogos WHERE fase = 'oitavas' AND id =  = '51'", $this->uri->segment("3"))->row(0);
        $data['jogo']['52'] = $this->db->query("SELECT * FROM jogos WHERE fase = 'oitavas' AND id =  = '52'", $this->uri->segment("3"))->row(0);
        $data['jogo']['53'] = $this->db->query("SELECT * FROM jogos WHERE fase = 'oitavas' AND id =  = '53'", $this->uri->segment("3"))->row(0);
        $data['jogo']['54'] = $this->db->query("SELECT * FROM jogos WHERE fase = 'oitavas' AND id =  = '54'", $this->uri->segment("3"))->row(0);
        $data['jogo']['55'] = $this->db->query("SELECT * FROM jogos WHERE fase = 'oitavas' AND id =  = '55'", $this->uri->segment("3"))->row(0);
        $data['jogo']['56'] = $this->db->query("SELECT * FROM jogos WHERE fase = 'oitavas' AND id =  = '56'", $this->uri->segment("3"))->row(0);
